	...
	def paginate = { attrs ->
		...
		if (currentstep > firststep) {
			...
			writer << link(linkTagAttrs.clone()) {
				"&laquo;" + (attrs.prev ?: messageSource.getMessage('default.paginate.prev', null, '&laquo;', locale))
			}
			writer << '</li>'
		}
		else {
			...
			writer << '<span>'
			writer << "&laquo;" + (attrs.prev ?: messageSource.getMessage('default.paginate.prev', null, '&laquo;', locale))
			writer << '</span>'
			writer << '</li>'
		}
		...
		if (currentstep < laststep) {
			...
			writer << link(linkTagAttrs.clone()) {
				(attrs.next ? attrs.next : messageSource.getMessage('default.paginate.next', null, 'Próxima', locale)) + " &raquo;"
			}
			writer << '</li>'
		}
		else {
			...
			writer << '<span>'
			writer << (attrs.next ? attrs.next : messageSource.getMessage('default.paginate.next', null, 'Próxima', locale)) + " &raquo;"
			writer << '</span>'
			writer << '</li>'
		}
