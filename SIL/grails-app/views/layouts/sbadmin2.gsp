    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; background-color: rgba(231,231,231,0.8);">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${request.contextPath}/sbadmin2/pages/index.html"><i>SIL - Sistema Integrado de Licitações</i></a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="#">
                                ...
                                <div>Algum texto deixado na mensagem. Pode sse referir a uma cobrança de atividade, um lembrete...</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                ...
                                <div>Bem-vindo! Muito bom encontrá-lo por aqui. Espero que goste...</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                <div>
                                    <strong>Ana Correa</strong>
                                    <span class="pull-right text-muted">
                                        <em>Ontem</em>
                                    </span>
                                </div>
                                <div>Senhor, os documentos que você pediu foram impressos e estão na sua mesa...</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                    ...
                    <ul class="dropdown-menu dropdown-tasks">
                            ...
                            <a href="#">
                                <div>
                                    <p>
                                        ...
                                        <span class="pull-right text-muted">40% Concluída</span>
                                    </p>
                                    <div class="progress progress-striped active">
                                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%">
                                            <span class="sr-only">40% Concluída (sucesso)</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="#">
                                <div>
                                    <p>
                                        ...
                                        <span class="pull-right text-muted">20% Concluída</span>
                                    </p>
                                    <div class="progress progress-striped active">
                                        <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%">
                                            <span class="sr-only">20% Concluída</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="#">
                                <div>
                                    <p>
                                        ...
                                        <span class="pull-right text-muted">60% Concluída</span>
                                    </p>
                                    <div class="progress progress-striped active">
                                        <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%">
                                            <span class="sr-only">60% Concluída (advertênca)</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    <p>
                                        <strong>Atividade 4</strong>
                                        <span class="pull-right text-muted">80% Concluída</span>
                                    </p>
                                    <div class="progress progress-striped active">
                                        <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
                                            <span class="sr-only">80% Concluída (perigosa)</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li>
                            <a class="text-center" href="#">
                                <strong>Ver todas as atividades</strong>
                                <i class="fa fa-angle-right"></i>
                            </a>
                        </li>
                    </ul>
